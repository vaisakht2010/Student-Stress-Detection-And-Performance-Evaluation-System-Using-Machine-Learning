...
if ($input_name == ""){
			...
			$name_notification  = 'Add Assignment file name'." ".'<b>'.$name.'</b>';
                ...
                mysqli_query($conn,"INSERT INTO assignment (fdesc,fdatein,teacher_id,class_id,fname,time_required) VALUES ('$filedesc',NOW(),'$session_id','$id_class','$name','$time_required')")or die(mysqli_error());
   ...
   $newname = "admin/uploads/" . $rd2 . "_" . $filename;
        ...
        //Check if the file with the same name is already exists on the server
            ...
            (move_uploaded_file($_FILES['uploaded_file']['tmp_name'], $newname));
                ...
                $qry2 = "INSERT INTO assignment (fdesc,floc,fdatein,teacher_id,class_id,fname,time_required) VALUES ('$filedesc','$newname',NOW(),'$session_id','$id_class','$name','$time_required')";
